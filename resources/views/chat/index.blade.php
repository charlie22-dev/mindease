    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .chat-input-bar {
                ...
                /* Extra padding for mobile bottom bar sweeping */
            }
        }
    </style>
@endsection
            ...
            <div class="clear-btn-wrap">
                ...
                @if($messages->count() > 0)
                    <form method="POST" action="{{ route('chat.clear') }}">
                        @csrf
                        <button type="submit" class="btn btn-ghost" style="font-size:0.8rem; padding:0.35rem 0.85rem;"
                            onclick="return confirm('Clear chat?')">
                            Clear
                        </button>
                    </form>
                @endif
        ...
        <div class="chat-messages" id="chat-box">
            @if($messages->isEmpty())
                <div class="empty-state" id="empty-state">
                    <h3
                        style="font-family: 'Merriweather', serif; font-size: 1.35rem; font-weight: 400; color: var(--text); margin-bottom: 0.5rem;">
                        Hello, {{ Auth::user()->name }}</h3>
                    <p style="font-size: 0.85rem; color: var(--muted); margin-bottom: 1.5rem;">Share what's on your mind. I'm
                        here to listen without judgment.</p>
                    <div class="starters">
