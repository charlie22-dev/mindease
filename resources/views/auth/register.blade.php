...
<head>
    ...
    <title>MindEase — Create Account</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .login-link a:hover { color: #c8e8cc; }
...
<div class="register-card">
    <div class="card-header">
        <h1 class="card-title">Begin your journey</h1>
        <p class="card-sub">Create a free account and find your calm.</p>
    </div>
