...
@section('head')
    <style>
        ...
        .mood-page::-webkit-scrollbar {
            width: 3px;
        }

        .mood-page::-webkit-scrollbar-thumb {
        ...
        .mood-opt:nth-child(1) .e {
            animation-delay: 0.1s;
            animation-duration: 3.1s;
        }

        .mood-opt:nth-child(2) .e {
            animation-delay: 0.3s;
            animation-duration: 2.9s;
        }

        .mood-opt:nth-child(3) .e {
            animation-delay: 0px;
            animation-duration: 3.2s;
        }

        .mood-opt:nth-child(4) .e {
            animation-delay: 0.2s;
            animation-duration: 2.8s;
        }

        .mood-opt:nth-child(5) .e {
        ...
        <div class="mood-grid">
            ...
            <div class="card">
                ...
                <form method="POST" action="{{ route('mood.store') }}">
                    ...
                    <button type="submit" id="log-btn" class="btn btn-primary" disabled
                        ...
                        @foreach($recentMoods as $m)
                            <div class="history-item">
                                ...
                                <div class="h-info">
                                    ...
                                    @if($m->note)
                                    <div class="h-note">"{{ $m->note }}"</div>@endif
                                </div>
